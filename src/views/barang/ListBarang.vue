    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        >
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-lg btn-primary w-100">
              <span class="indicator-label">Update Barang</span>
              <span class="indicator-progress">
                Please wait...
                <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
              </span>
  ...
  setup() {
    ...
    const onAddSatuan = async (values: any) => {
      try {
        ...
        const response = await ApiService.post('barang', requestData);
    ...
    const onEditBarang = async (values: any) => {
      try {
        ...
        const response = await ApiService.put2(`barang`, requestData);
