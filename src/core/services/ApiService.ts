...
class ApiService {
  ...
  public static get2(
    resource: string,
    data: any = {}  // This is where you will pass the request body
  ): Promise<AxiosResponse> {
    return ApiService.vueInstance.axios.request({
      ...
      data,  // Send the request body here
    });
  }
  ...
  public static del(resource: string, params: any): Promise<AxiosResponse> {
    return ApiService.vueInstance.axios.delete(`${resource}`, params);
  }

  public static put2(resource: string, params: any): Promise<AxiosResponse> {
    return ApiService.vueInstance.axios.put(`${resource}`, params);
  }
